...
namespace NewPascalCompiler.Intermediate.SymbolTable
{
    public class Definition
    {
        ...
        public static readonly Definition EnumerationConstnt = new Definition("enumeration constant");
        ...
        public static readonly Definition ProgramParamn = new("program parameter");
